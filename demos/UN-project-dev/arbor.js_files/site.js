...
(function($){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['UN','DPA','DFS','DM']) >=0 ){
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"UN":{color:"red", shape:"dot", alpha:1}, 
      
             DM:{color:CLR.branch, shape:"dot", alpha:1}, 
             OICT:{color:CLR.demo, alpha:0, link:'/halfviz'},
             OHRM:{color:CLR.demo, alpha:0, link:'/atlas'},
             OPPBA:{color:CLR.demo, alpha:0, link:'/echolalia'},

             DFS:{color:CLR.branch, shape:"dot", alpha:1}, 
             LSD:{color:CLR.doc, alpha:0, link:'#reference'},
             ICTD:{color:CLR.doc, alpha:0, link:'#introduction'},

             DPA:{color:CLR.branch, shape:"dot", alpha:1},
             "Africa II":{color:CLR.code, alpha:0, link:'https://github.com/samizdatco/arbor'},
             "SCAD":{color:CLR.code, alpha:0, link:'/js/dist/arbor-v0.92.zip'},
             "Africa I":{color:CLR.code, alpha:0, link:'/js/dist/arbor-v0.92.tar.gz'}
            },
      edges:{
        "UN":{
          DM:{length:.8},
